...
class Post(models.Model):
    ...
    # sjk = models.OneToOneField('self', on_delete=models.CASCADE, blank=True, null=True)
    image = models.ImageField('Изображение', upload_to='images/')
    image2 = models.ImageField('Изображение2', upload_to='images/', blank=True, null=True)
    image3 = models.ImageField('Изображение3', upload_to='images/', blank=True, null=True)
